...
import type { PolicyResponse } from "../../../core/interfaces/Policy";

interface PolicyProviderRowActionProps {
    row: PolicyResponse;
    handleEdit: (uuid: string) => void;
    handleStatus: (uuid: string, status: string) => void;
}

export const PolicyProviderRowAction: React.FC<PolicyProviderRowActionProps> = ({
    row,
    handleEdit,
    handleStatus
}) => {
